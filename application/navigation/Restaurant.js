...
import RestBottomTabs from './RestBottomTabs';
...
const RestNotificationStack = createStackNavigator();
const RestNotificationScreen = () => {
    return(
        <RestNotificationStack.Navigator
            initialRouteName='restnotifications'
            screenOptions={{
        ...
        >
            <RestNotificationStack.Screen 
                name='restnotifications'
                component={RestNotifications}
                options={{
...
const RestDrawer = createDrawerNavigator();
...
const Restaurant = () => {
    return(
        <RestDrawer.Navigator
            drawerContent={CustomDrawerContent}
            initialRouteName='resthome'
        ...
        >
            ...
            <RestDrawer.Screen 
                name='restnotifications'
                component={RestNotificationScreen}
                options={{
