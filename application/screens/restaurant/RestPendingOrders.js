...
const RestPendingOrders = ({navigation}) => {

    //Accept Alert
    const _showAcceptAlert = () => {
        Alert.alert(
            "Alert",
            ...
            <FlatList 
                ...
                renderItem={({item, index})=>{
                    return(
                        ...
                        >
                            <TouchableOpacity
                                onPress={()=>{ _gotoRestOrdersDetails(navigation, item, 'pending' ) }}
...
export default RestPendingOrders;